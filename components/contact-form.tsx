...
function fieldClasses(hasError?: boolean) {
  return cn(
    "mt-1.5 block w-full rounded-xl border bg-surface px-3.5 py-2.5 text-sm text-ink shadow-[0_1px_2px_rgba(20,33,46,0.04)] outline-none transition-[border-color,box-shadow] placeholder:text-ink-faint",
...
export function ContactForm({ defaultInterest }: { defaultInterest?: string }) {
  ...
  if (state.status === "success") {
    return (
      <div className="flex flex-col items-center gap-4 rounded-2xl border border-accent/25 bg-accent-soft p-10 text-center">
